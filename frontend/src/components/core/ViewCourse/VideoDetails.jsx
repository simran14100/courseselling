  ...
  const handleLectureCompletion = async () => {
    ...
    try {
      ...
      console.log('Marking lecture as complete:', { 
        courseId, 
        subsectionId,
        userId // Log the user ID being used
      });
      ...
      const res = await markLectureAsComplete(
        { 
          courseId, 
          subsectionId,
          userId // Make sure userId is included in the request
        },
        token
      );
      
      console.log('Mark lecture complete response:', res);
      ...
      if (res?.success) {
        ...
        if (response?.success) {
          // Log the progress data we're about to save
          console.log('Progress data to save:', {
            ...
            totalSubsections: response.data.totalSubsections
          });
          
          dispatch(setEntireCourseData(response.data));
          console.log('Course data updated in Redux store');
          
          // Get the updated data from Redux using the existing selector
          console.log('Course data updated in Redux. Refreshing UI...');
          
          // The Redux state will automatically update the component
          // No need to read it here as it will cause a re-render
        }
      }
    } catch (error) {
